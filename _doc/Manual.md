...
```yml
# Site settings
title: LZS Blog             # title of your website
SEOTitle: LZS Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: Foker     # modify this account to yours
weibo_username: Foker      # the footer woule be auto-updated.
